 ...
 * @param {*} radius
 */
export function strokeHalfCircle(x, y, radius) {
	fillHalfEllipse(x, y, radius, radius);
}
/**
...
export function strokeHalfEllipse(x, y, rX, rY) {
	context.beginPath();
	context.ellipse(x, y, rX, rY, 0, 0, Math.PI, false);
	context.stroke();
	context.fill();
}
...
export function BellyHalfEllipse(x, y, rX, rY) {
	context.beginPath();
	context.ellipse(x, y, rX, rY, 0, 0, Math.PI, true);
	context.stroke();
	context.fill();
}
